...
public class VerticalSum {
    ...
    // Constructors
    public VerticalSum() { root = null; }
    public VerticalSum(TreeNode n) { root = n; }
...
Following is Java implementation for the same. 
HashMap is used to store the vertical sums for different horizontal distances. 
Thanks to Nages for suggesting this method.
 */
